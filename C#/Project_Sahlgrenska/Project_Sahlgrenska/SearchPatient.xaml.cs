...
namespace Project_Sahlgrenska
{
    ...
    public partial class SearchPatient : Window
    {
        ...
        {
            Bot.Update("UPDATE bt0mlsay6vs1xbceqzzn.patients SET History = CONCAT(NOW(), ' ++ Patienten utskriven från sjukhuset och " + patientRoom.Text + "', COALESCE(CONCAT(CHAR(10), History), '')), SentHome = NOW() WHERE ID = '" + patientId.Text + "';");
